...
namespace MarkJPriceCSharp9DotNet5.Ch17_0.Controllers
{
    ...
    public class SetupController : Controller
    {
        ...
        public async Task<IActionResult> Seed()
        {
            ...
            startPage.Blocks.Add(new ColumnBlock
            {
                Items = new List<Block> { new PageBlock { Body = blogPage }, new PageBlock { Body = docsPage } }
            });
            startPage.Blocks.Add(new HtmlBlock
            {
                Body =
            ...
            {
                Body = "<p class=\"lead\">Big thanks to <a href=\"https://github.com/mikaellindemann\">@mikaellindemann</a> and <a href=\"https://github.com/Urreman\">@Urreman</a> for their contributions and all of the people who has helped with translating the manager.</p>"
            });
            post3.Blocks.Add(new ColumnBlock
            {
                Items = new List<Block>
                {
                    ...
                    new ImageBlock {Body = images["person-looking-at-phone-and-at-macbook-pro-1181244.jpg"]}
                }
            });
